    ...
    function importColumnsData()
    {
        ...
        if (!empty($tree_value)) {
            ...
            foreach($parts as $n => $part) {
                $part = Tools::toEntityString(str_replace($this->tree_delimiter_replacer, $this->tree_delimiter, $part));
    ...
    protected function getRecursiveField($current_id)
    {
        ...
        while($id && $id != $this->root_value) {
            ...
            if ($row) {
                ...
                $item = Tools::unEntityString($row[$this->getMappedField($this->tree_field)]);
