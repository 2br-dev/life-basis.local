...
class Paginator
{
    ...
    */
     ...
     * @return string
     */
    function getPageHref($page, $absolute = false)
    {
        switch($this->pattern_type) {
            ...
            default: {
                $href = Manager::obj()->getUrl($this->pattern_type,
                    $this->route_params + [$this->pattern => ($page != 1) ? $page : null]);
            }
        }

        if ($absolute) {
            $href = Manager::obj()->buildAbsoluteUrl($href);
        }
