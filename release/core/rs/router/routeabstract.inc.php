...
abstract class RouteAbstract
{
    ...
    */
    function buildUrl($params, $absolute = false)
    {
        ...
        if ($absolute) {
            $current_site = $this->getSiteContext();
    ...
    /**
     * Устанавливает сайт, в контексте которого будут строиться URL
     *
     * @param Site $site
     * @return $this
     */
    function setSiteContext(Site $site)
    {
        $this->site = $site;
        return $this;
    }
    ...
    {
        return $this->site ?? \RS\Site\Manager::getSite();
    }
