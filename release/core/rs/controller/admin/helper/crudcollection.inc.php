...
class CrudCollection implements \ArrayAccess
{
    ...
    */
    function getFormTitle()
    {
        ...
        if (strpos((string)$this->collection['formTitle'], '{') !== false) {
        ...
        $this->controller->app->title->addSection(strip_tags((string)$result), 'crud-form-title');
        return $result;
    }
    ...
    * @return object
    */
    function getApi($key = null)
    {
        if ($key && isset($this->other_api[$key])) {
    ...
    */
     ...
     *
     * @return \RS\Controller\AbstractModule
     */
