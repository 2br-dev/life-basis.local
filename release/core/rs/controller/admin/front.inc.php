...
class Front extends AbstractAdmin
{
    ...
    function exec($returnAsIs = false)
    {
        ...
        if ($this->wrap_output && substr($this->act, 0, 4) != 'ajax' && !$this->url->isAjax()) {
            ...
            $has_marketplace_right = defined('Marketplace\Config\ModuleRights::RIGHT_VIEW_MENU_MARKETPLACE') ?
                $this->user->checkModuleRight('marketplace', \Marketplace\Config\ModuleRights::RIGHT_VIEW_MENU_MARKETPLACE) : true;
