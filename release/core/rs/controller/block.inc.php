...
use RS\Controller\Utils\BlockCacheManager;
...
abstract class Block extends AbstractClient
{
    ...
    function __construct($param = [])
    {
        ...
        $cache = BlockCacheManager::obj()->tags([CACHE_TAG_BLOCK_PARAM]);
    ...
    {
        if (BlockCacheManager::obj()->exists($this->store_key)) {
            $loaded_params = BlockCacheManager::obj()->read($this->store_key);
     ...
     * @return bool
     */
    public static function isVisibleOnSiteConstructor()
    {
        return true;
    }
}