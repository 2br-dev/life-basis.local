...
abstract class AbstractClient extends AbstractModule
{
    ...
    function processResult($result)
    {
        ...
        if ($this->canProcessResult())
        {
            ...
            /**
             * @var $info \RS\Debug\Tool\Info
             */
            $info = $debug_group->getTools('info');
            if ($info && $result instanceof \RS\Controller\Result\ITemplateResult) {
                ...
                $info->render_template = $result->getTemplate();
