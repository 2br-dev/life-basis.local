...
class CheckboxVariableListField extends AbstractVariableListField
{
    ...
    {
        return "<input type='checkbox' name='{$this->wrapField($field_name)}[$row_index][{$this->getName()}]' value='{$this->on_value}'".($value == $this->on_value ? 'checked' : '').$this->getAttributesInline().">";
    }
}