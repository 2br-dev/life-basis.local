    ...
    function getUrl($width, $height, $img_type = 'xy', $absolute = false, $force_create = false)
    {
        if ($this->get()) {
            if ($this->getExtension() == 'svg') {
                ...
                $image_core = $this->getImageCore();
                $url = $image_core->getImageUrl($this->getRealPath(), $width, $height, $img_type);

                if ($force_create) {
                    $image_core->buildImage($this->getRealPath(), $width, $height, $img_type);
                }
