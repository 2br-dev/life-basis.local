...
class File extends AbstractType
{
    ...
    */
    ...
    {
        if (preg_match('/(.*?)_(.*)/', (string)$this->get(), $match))
        {
            return $match[1];
        }
        return false;
    ...
    */
    ...
    /**
     * Устанавливает допустимые расширения загружаемых файлов
     *
     * @param array $types
     */
    function setAllowFileTypes(array $types)
    {
        $this->allow_file_types = $types;
        return $this;
    }
