...
abstract class ConfigObject extends AbstractObject implements ConfigInterface
{
     ...
     * конфигурации для заданного или текущего сайта
     *
     * @param null $site_id
     * @return static|bool(false)
     */
    public static function config($site_id = null)
    {
        return Loader::byModule(get_called_class(), $site_id);
    }
}
