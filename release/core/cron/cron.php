...
class CronEventRiser
{
    ...
    public function run()
    {
        ...
        // устанавливаем обработчик небросаемых ошибок
        ...
        try {
            $time = null;
            EventManager::initCronListeners();
            EventManager::fire('cron', [
    ...
    /**
     * Устанавливает обработчик, который будет записывать
     * в лог все типы ошибок вместе со стектрейсом
     */
