...
{addcss file="flatadmin/app.css?v=4" basepath="common" no_compress=true}
                    ...
                    <div class="dropdown rs-meter-group">
                        ...
                        <ul class="ft-dropdown-menu" aria-labelledby="floatTools">
                            ...
                            <li class="ft-hover-node">
                                ...
                                <ul class="ft-sub">
                                    <li>
                                        <a href="{adminUrl mod_controller="users-ctrl" do="myQrCode"}" class="crud-edit crud-sm-dialog">
                                            <i class="rs-icon zmdi zmdi-fullscreen"></i>
                                            <span>{t}QR-код{/t}</span>
                                        </a>
                                    </li>
                                    <li>
...
<aside id="sidebar">
    ...
    <div class="side-scroll">
        ...
        {if ModuleManager::staticModuleExists('marketplace') && $has_marketplace_right}
