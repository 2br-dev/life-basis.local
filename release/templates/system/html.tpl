...
{$css.params.before}<link {if !empty($css.params.type)}type="{$css.params.type|default:"text/css"}"{/if} href="{$css.file}" {if !empty($css.params.hreflang)}hreflang="{$css.params.hreflang}"{/if} {if !empty($css.params.media)}media="{$css.params.media|default:"all"}"{/if} rel="{$css.params.rel|default:"stylesheet"}"{if !empty($css.params.as)} as="{$css.params.as}"{/if}{if !empty($css.params.crossorigin)} crossorigin="{$css.params.crossorigin}"{/if}>{$css.params.after}
{/foreach}
