...
{$api_key = $main_config.yandex_js_api_geocoder}
{addJS file="//api-maps.yandex.ru/2.1/?lang=ru_RU&apikey={$api_key}" basepath="root"}
{addJS file="jquery.ui/jquery.autocomplete.js" basepath="common"}
<script>
    var ya_qt,                //Таймер
            ya_queryItemsCnt = 5, //Количество элементов для подгрузки
            ya_queryUrl      = 'https://geocode-maps.yandex.ru/1.x/?lang=ru_RU&apikey={$api_key}', //Url куда стучатся за результами поиска
    ...
    $.allReady(function() {
        ...
        function init(){
            ...
            myPlacemark = new ymaps.Placemark([{$lat}, {$lng}], {
                balloonContent: '{$address|escape:"javascript"}'
            },{
                draggable: true
            });
