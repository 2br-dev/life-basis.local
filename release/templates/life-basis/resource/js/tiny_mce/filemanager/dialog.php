...
<html>
    <head>
        ...
        <link rel="stylesheet" href="libs/jplayer/dist/skin/blue.monday/jplayer.blue.monday.css" />
        <link rel="stylesheet" href="libs/toast-ui/tui-image-editor.css">
        <link rel="stylesheet" type="text/css" href="libs/toast-ui/tui-color-picker.css">
        ...
        <script src="libs/jquery/jquery-1.12.4.min.js" crossorigin="anonymous"></script>
        <script src="libs/jquery/jquery-ui.min.js" crossorigin="anonymous"></script>
        <script src="js/plugins.js?v=<?php echo $version; ?>"></script>
        <script src="libs/jplayer/dist/jplayer/jquery.jplayer.min.js"></script>
        <script src="libs/toast-ui/fabric.js"></script>
        <script src="libs/toast-ui/tui-code-snippet.min.js"></script>
        <script src="libs/toast-ui/filesaver.min.js"></script>
        <script src="libs/toast-ui/tui-color-picker.js"></script>
        <script src="libs/toast-ui/tui-image-editor.js"></script>
...
<body>
    ...
    <script src="libs/blueimp-tmpl/tmpl.min.js"></script>
    <!-- The Load Image plugin is included for the preview images and image resizing functionality -->
    <script src="libs/blueimp-loadimage/load-image.all.min.js"></script>
    <!-- The Canvas to Blob plugin is included for image resizing functionality -->
    <script src="libs/blueimp-canvas-to-blob/canvas-to-blob.min.js"></script>
	...
	<div class="span12">
        ...
        foreach ($files as $file_array) {
            ...
            foreach ($files as $nu=>$file_array) {
                ...
                $filename=$file; //substr($file, 0, '-' . (strlen($file_array['extension']) + 1));
                ...
                if(!$ftp){
                    ...
                    if($file!=fix_filename($file,$config)){
                        ...
                        $filename = $file1; //substr($file1, 0, '-' . (strlen($file_array['extension']) + 1));
                        if(strlen($file_array['extension'])===0){
                            $filename = $file1;
                        }
                ...
                if(in_array($file_array['extension'], $config['ext_img'])){
                    ...
                    if($ftp){
                        ...
                        $mini_src = $src_thumb = $cur_dir_thumb. $file;
                        ...
                        if($img_width<122 && $img_height<91){
                            $src_thumb = $config['upload_dir'].$rfm_subfolder.$subdir.$file;
                            $show_original=true;
                        }
