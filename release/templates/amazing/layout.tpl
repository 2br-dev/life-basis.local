...
{strip}
    ...
    {addcss rel="preload" file="{$THEME_IMG}/icons/loader.svg" as="image" basepath="root" crossorigin="anonymous" no_compress=true}
    ...
    {addjs file="libs/glightbox.min.js"}
