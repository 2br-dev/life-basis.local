<div id="modal-bonuscardinfo">
    <ion-header>
        <div class="container">
            <div class="modal-bonuscardinfo-head">
                <div class="modal-bonuscardinfo-head__flex-1">
                ...
                <div class="modal-bonuscardinfo-head__title"></div>
                <div class="modal-bonuscardinfo-head__flex-1"></div>
            </div>
        </div>
    </ion-header>
