<div id="modal-sort">
  <ion-header>
    <div class="container">
      <div class="modal-sort-head">
        <div class="modal-sort-head__flex-1">
        ...
        <div class="modal-sort-head__title">
          {t}Сортировка{/t}
        </div>
        <div class="modal-sort-head__flex-1"></div>
      </div>
    </div>
  </ion-header>
  <div class="inner-content">
    <div class="section" *ngIf="sortList">
      <div class="container">
        <ul class="modal-sort-list">
          <li *ngFor="let item of sortList">
            <button
              type="button"
              class="modal-sort-link"
              [ngClass]="{ 'modal-sort-link_active': getCurrentSort()===item.type}"
              (click)="setSort(item.type)"
            >
              { { item.title } }
            </button>
          </li>
