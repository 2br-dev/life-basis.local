<div id="modal-setamount" *ngIf="product">
  <ion-header>
    <div class="modal-setamount-head">
      <div class="modal-setamount-head__title">
        <img [src]="product.getMainImage()['micro_url']" class="modal-setamount-head__img">
        {t}Колличество{/t}
      </div>
  ...
  <div class="amount_wrapper">
    <div class="amount_input__wrapper">
      ...
      <button
        ...
        *ngIf="amountInCart && amountInCart != 0 && amountInCart != '.'"
