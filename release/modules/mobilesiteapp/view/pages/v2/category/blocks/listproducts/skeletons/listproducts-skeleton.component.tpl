<div class="catalog-list">
  <div style="border: 1px solid var(--color-gray); padding: 16px 8px 12px; border-radius: 12px;">
...
<div class="catalog-more">
  <ion-skeleton-text animated style="width: 100%; max-width: 305px; height: 56px;"></ion-skeleton-text>
</div>
