  ...
  <ion-toolbar>
    <div class="container">
      <div class="head">
        ...
        <div class="head__title">{t}Выбор пункта выдачи{/t}</div>
...
<ion-content [fullscreen]="true">
  <div id="checkout-selectpvz">
    <div class="content">
      <div class="map-info" *ngIf="inLoading">
        <app-selectpvz-skeleton></app-selectpvz-skeleton>
      </div>
      <div class="map" *ngIf="!inLoading">
        <div class="map-container">
          <ya-map
            (yaclick)="openPvzModal($event)"
            [center]="mapCenter"
            [zoom]="10"
          ...
          >
            <ya-placemark
              (yaclick)="openPvzModal($event, pvz)"
              [options]="{ preset: pvz.preset }"
              [properties]="{ balloonContentHeader : pvz.title, balloonContentBody : pvz.city +'<br>'+ pvz.region +'<br>'+ pvz.address }"
              [geometry]="[pvz.coord_y, pvz.coord_x]"
              *ngFor="let pvz of pvzList"
            ></ya-placemark>
          </ya-map>
        </div>
      </div>
