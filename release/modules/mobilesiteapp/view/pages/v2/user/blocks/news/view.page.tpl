  ...
  <ion-toolbar>
    <div class="container">
      <div class="head">
        ...
        <div class="head__title" *ngIf="article && !inLoading" [innerHTML]="article.title"></div>
...
<ion-content [fullscreen]="true">
  <div id="news">
    <div class="section">
      {if $client_version >= 3.2}
        <app-newsview-skeleton *ngIf="inLoading"></app-newsview-skeleton>
      {/if}
      <div class="container" *ngIf="article && !inLoading">
        <ion-grid>
          <ion-row>
            <div class="article-image w-100 ion-text-center" *ngIf="article.getImage()">
              <img [src]="article.getImage()['big_url']" width="474" height="319" alt="">
            </div>
