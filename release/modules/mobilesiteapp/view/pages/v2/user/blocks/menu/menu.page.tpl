  ...
  <ion-toolbar>
    <div class="container">
      <div class="head">
        ...
        <div class="head__title">{t}Информация{/t}</div>
          ...
          <ion-row>
            ...
            <ion-col size-lg="5" size-md="6" offset-lg="1" size="12">
              ...
              <div class="margin-16-left-table" *ngIf="!inLoading">
                <ul class="info-menu" *ngIf="menuList && menuList.length">
                  <li class="info-menu__item" *ngFor="let menu of menuList">
                    <a class="info-menu__link" (click)="openMenu(menu)" [innerHTML]="menu.title"></a>
                  </li>
                </ul>
                <p *ngIf="!menuList">
