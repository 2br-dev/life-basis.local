  ...
  <ion-toolbar>
    <div class="container">
      <div class="head">
        ...
        <div class="head__title">{t}Управление профилем{/t}</div>
          ...
          <ion-row>
            ...
            <ion-col size-lg="5" size-md="6" offset-lg="1" size="12">
              <div class="margin-16-left-table">
                <div>
                  <p>{t}В данном разделе вы можете сделать запрос на удаление вашего профиля.{/t}</p>
                  <p>{t}Запрос будет обработан нашими менеджерами.{/t}</p>

                  <button
                    type="submit"
                    class="button button_primary w-100 margin-40-top margin-40-bottom"
