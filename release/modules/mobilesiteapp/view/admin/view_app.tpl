...
<div class="mobile-site-app view">
    ...
    <div class="view-columns">
        ...
        {if $info['app_generation'] == 1}
            <div class="preview">
                <div class="phone"></div>
                <div class="page">
                    {if $info.settings}
                        {include file="admin/phonepreview.tpl"}
                    {else}
                        <div class="wait"></div>
                    {/if}
                </div>
        ...
        {else}
            <div class="second_generation">
                <div class="phone"></div>
                <div class="page">
                    {if $info.settings}
                        {include file="admin/phonecontent.tpl"}
                    {else}
                        <div class="wait"></div>
                    {/if}
                </div>
            ...
            <div class="item">
                ...
                {if $info.url_appstore || $info.url_googleplay}
                    <div class="app-links">
                        ...
                        <a href="{$router->getAdminUrl('showQrCode')}" class="crud-edit crud-sm-dialog"
                           title="{t}Показать общий QR-код для установки приложений для iOS и Android{/t}">
                            <img src="{$mod_img}/qr-fake.svg" width="54" height="54">
                        </a>
                    </div>
                {else}
                    <p class="value">
