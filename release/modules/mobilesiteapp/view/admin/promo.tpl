    ...
    <div class="info-columns">
        ...
        <div class="screenshots">
            ...
            <div class="owl-carousel images">
                <div><img src="{$mod_img}/screen/scr_1.png"></div>
                <div><img src="{$mod_img}/screen/scr_2.png"></div>
                <div><img src="{$mod_img}/screen/scr_3.png"></div>
                <div><img src="{$mod_img}/screen/scr_4.png"></div>
                <div><img src="{$mod_img}/screen/scr_5.png"></div>
                <div><img src="{$mod_img}/screen/scr_6.png"></div>
                <div><img src="{$mod_img}/screen/scr_7.png"></div>
            </div>
            <div class="phone"></div>
