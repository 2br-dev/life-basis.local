...
class AppApi extends \RS\Module\AbstractModel\BaseModel
{
    ...
    /**
     * Возвращает список всплывающих уведомлений для приложения
     *
     * @return array
     */
    static public function getToastNotificationsFields()
    {
        $fields = [];
        $fields['user_update'] = t('Обновление пользователя');
        $fields['user_delete'] = t('Удаление пользователя');
        $fields['product_add_to_card'] = t('Товар добавлен в корзину');
        $fields['product_add_to_favorite'] = t('Товар добавлен в избранного');
        $fields['product_delete_from_favorite'] = t('Товар удален из избранного');
        $fields['settings_update'] = t('Обновление настроек уведомления');
        $fields['system_notifications'] = t('Системные уведомления');
