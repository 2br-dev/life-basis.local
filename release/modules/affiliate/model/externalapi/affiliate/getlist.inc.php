...
/**
* Возвращает список филиалов в городах
*/
class GetList extends \ExternalApi\Model\AbstractMethods\AbstractGetTreeList
{
    ...
    */
    ...
    {
        return [
            self::RIGHT_LOAD => t('Загрузка списка Филиалов в городах.')
        ];
    }
    ...
    */
    ...
    {
        if ($this->dao === null) {
            $this->dao = new \Affiliate\Model\AffiliateApi();
    ...
    *                  "parent_id": "0",
    *                  "clickable": "0", //Можно ли выбирать филиал
    *                  "cost_id": "0",   //id цены установленной для филиала. 0 - Не выбрано, значит используется по умолчанию
    ...
    *                          "alias": "krasnodar",
    *                          "parent_id": "1",
    *                          "clickable": "1",  //Можно ли выбирать филиал
    *                          "cost_id": "0", //id цены установленной для филиала. 0 - Не выбрано, значит используется по умолчанию
