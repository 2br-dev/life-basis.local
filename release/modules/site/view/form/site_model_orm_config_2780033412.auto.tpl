        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="site-config-tab1" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__logo_inverse->getTitle()}&nbsp;&nbsp;{if $elem.__logo_inverse->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__logo_inverse->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__logo_inverse->getRenderTemplate() field=$elem.__logo_inverse}</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__firm_ogrn->getTitle()}&nbsp;&nbsp;{if $elem.__firm_ogrn->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__firm_ogrn->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__firm_ogrn->getRenderTemplate() field=$elem.__firm_ogrn}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="site-config-tab4" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__agreement_cookie->getTitle()}&nbsp;&nbsp;{if $elem.__agreement_cookie->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__agreement_cookie->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__agreement_cookie->getRenderTemplate() field=$elem.__agreement_cookie}</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__agreement_personal_data_phrase->getTitle()}&nbsp;&nbsp;{if $elem.__agreement_personal_data_phrase->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__agreement_personal_data_phrase->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__agreement_personal_data_phrase->getRenderTemplate() field=$elem.__agreement_personal_data_phrase}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="site-config-tab5" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__manifest_name->getTitle()}&nbsp;&nbsp;{if $elem.__manifest_name->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__manifest_name->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__manifest_name->getRenderTemplate() field=$elem.__manifest_name}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__manifest_short_name->getTitle()}&nbsp;&nbsp;{if $elem.__manifest_short_name->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__manifest_short_name->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__manifest_short_name->getRenderTemplate() field=$elem.__manifest_short_name}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__manifest_icon->getTitle()}&nbsp;&nbsp;{if $elem.__manifest_icon->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__manifest_icon->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__manifest_icon->getRenderTemplate() field=$elem.__manifest_icon}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__manifest_display->getTitle()}&nbsp;&nbsp;{if $elem.__manifest_display->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__manifest_display->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__manifest_display->getRenderTemplate() field=$elem.__manifest_display}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__manifest_background_color->getTitle()}&nbsp;&nbsp;{if $elem.__manifest_background_color->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__manifest_background_color->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__manifest_background_color->getRenderTemplate() field=$elem.__manifest_background_color}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__manifest_theme_color->getTitle()}&nbsp;&nbsp;{if $elem.__manifest_theme_color->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__manifest_theme_color->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__manifest_theme_color->getRenderTemplate() field=$elem.__manifest_theme_color}</td>
                                </tr>
