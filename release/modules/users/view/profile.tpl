...
<div class="col-xxl-4 col-xl-5 col-md-6">
    ...
    <form method="POST">
        ...
        {if $user_config.request_confirm_subscribe_on}
            <div class="mb-3 mt-4">
                <input type="checkbox" id="subscribe_on" name="subscribe_on" value="1" {if $user.subscribe_on}checked{/if}>
                <label for="subscribe_on" class="ms-2">{t}Получать информацию о новостях, скидках и акциях{/t}</label>
            </div>
        {/if}
