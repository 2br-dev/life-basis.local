...
class Handlers extends HandlerAbstract
{
    ...
    public static function getRoute(array $routes)
    {
        ...
        $routes[] = new Router\Route('users-front-profile', ['/my/{Act:(qrcode)}/', '/my/'], null, t('Профиль пользователя'), false, '^{pattern}$');
    ...
    public static function getMenus($items)
    {
        ...
        $items[] = [
            'title' => t('Запросы на удаление профиля'),
            'alias' => 'delete_profile_requests',
            'parent' => 'userscontrol',
            'link' => '%ADMINPATH%/users-deleteprofilerequestsctrl/',
            'sortn' => 62,
            'typelink' => 'link',
        ];
        return $items;
