 ...
 * которое предполагает подтверждение номера телефона в inline-поле
 */
abstract class AbstractVerifyTypePhone extends AbstractVerifyAction
{
    ...
    /**
     * Устанавливает имя поля ввода номера телефона
     *
     * @param $name
     * @return $this
     */
    ...
    /**
     * Устанавливает атрибуты поля ввода номера телефона
     *
     * @param array $attr
     * @return $this
     */
    ...
    /**
     * Устанавливает имя поля ввода токена
     *
     * @param string $name
     * @return $this
     */
    ...
    /**
     * Возвращает имя поля ввода номера телефона
     *
     * @return string
     */
    ...
    /**
     * Возвращает атрибуты поля ввода номера телефона
     *
     * @return array
     */
    ...
    /**
     * Возвращает имя поля ввода токена
     *
     * @return string
     */
