...
class VerifiedPhone extends Varchar
{
    ...
    public function getTokenFromPost()
    {
        ...
        return $params[$this->getTokenInputName()] ?? Request::commonInstance()->post($this->getTokenInputName(), TYPE_STRING);
    }
    ...
    public function getVerificationEngine()
    {
        ...
        if (!$phone) {
            $session['code_expire'] = null;
            $session['code_debug'] = null;
            $session['code_hash'] = null;
