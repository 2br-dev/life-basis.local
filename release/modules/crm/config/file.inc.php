    ...
    public function _init()
    {
        ...
        parent::_init()->append([
            ...
            t('Задачи'),
                ...
                'observer_user_groups' => new Type\ArrayList([
                    'description' => t('Группа, пользователи которой могут быть наблюдателями задач'),
                    'hint' => t('Используется для фильтрации пользователей в выпадающем списке'),
                    'list' => [['Users\Model\GroupApi', 'staticSelectList'], ["" => t('Все')]],
                    'Attr' => [['size' => 5, 'multiple' => 'multiple', 'class' => 'multiselect']],
                    'runtime' => false,
                ...
                'allow_archive_for_complete_statuses' => new Type\Integer([
                    'description' => t('Разрешить архивирование задач только для завершающих статусов?'),
                    'checkboxView' => [1, 0],
                    'default' => 1,
                ]),
    ...
    public static function getDefaultValues()
    {
        ...
        return parent::getDefaultValues() + [
            'tools' => [
                ...
                [
                    'url' => $router->getAdminUrl(false, [], 'crm-autotaskrulectrl'),
                    'title' => t('Правила для автозадач (устарело)'),
                    'description' => t('Устаревший раздел, который в последующих версиях будет удален. Используйте инструменты из меню CRM -> Автоматизация вместо данного раздела.'),
                    'class' => ' '
                ]
            ]
            ];
