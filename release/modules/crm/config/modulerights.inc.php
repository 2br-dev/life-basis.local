...
class ModuleRights extends DefaultModuleRights
{
    const
        ...
        TASK_CHAT_READ = 'task_chat_read',
        TASK_CHAT_UPDATE = 'task_chat_update',
        TASK_CHAT_READ_FILES = 'task_chat_read_files',
        TASK_CHAT_ADD_FILES = 'task_chat_add_files',
        ...
        TASK_OTHER_CHECKLIST_UPDATE = 'task_other_checklist_update',
    ...
    protected function getSelfModuleRights()
    {
        return [
            ...
            new RightGroup('crm_task', t('Задачи'), [
                ...
                new Right(self::TASK_OTHER_CHECKLIST_UPDATE, t('Изменение чужих чек-листов')),
                ...
                new Right(self::TASK_CHAT_READ, t('Просмотр чата')),
                new Right(self::TASK_CHAT_UPDATE, t('Добавление сообщений в чат')),
                new Right(self::TASK_CHAT_READ_FILES, t('Просмотр файлов в чате')),
                new Right(self::TASK_CHAT_ADD_FILES, t('Добавление файлов в чат')),
            ]),
            ...
            new RightGroup('crm_call_history', t('Звонки'), [
                ...
                new Right(self::CALL_HISTORY_UPDATE, t('Изменение')),
