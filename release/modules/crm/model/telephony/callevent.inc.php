...
class CallEvent
{
    ...
    private $shouldRegisterEvent = true;
     ...
     * @return self
     */
    public function setShouldRegisterEvent($bool)
    {
        $this->shouldRegisterEvent = $bool;
        return $this;
    }
    ...
    {
        return $this->shouldRegisterEvent;
    }
     ...
     * @return self
     */
    public function setReturnHeaders(array $headers)
    {
