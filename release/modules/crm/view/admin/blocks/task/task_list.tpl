...
{if $rights === null}
    {$rights['task_update'] = true}
    {$rights['task_read'] = true}
    {$rights['task_create'] = true}
    {$rights['task_delete'] = true}
{/if}
...
<div class="crm-block-task" data-refresh-url="{$this_controller->makeUrl()}"
    ...
    <div class="table-mobile-wrapper">
        <table class="rs-table values-list localform">
            ...
            <tbody {if !$rights['task_read']}hidden{/if}>
