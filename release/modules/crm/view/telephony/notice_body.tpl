        ...
        <div class="tel-user-info">
            ...
            <div class="user-data">
                ...
                <div class="user">
                    ...
                    {if $caller.id <= 0}
                        <div>
                            <a href="{adminUrl do="add" from_call=$call_history.id mod_controller="users-ctrl"}" class="btn btn-warning btn-rect btn-inline zmdi zmdi-plus crud-add" title="" data-original-title="Создать пользователя"></a>
                        </div>
                    {/if}
                </div>
