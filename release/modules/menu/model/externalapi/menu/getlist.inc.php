...
use ExternalApi\Model\AbstractMethods\AbstractGetTreeList;
...
*/
class GetList extends AbstractGetTreeList
{
    const RIGHT_LOAD = 1;
    ...
    */
    protected function process($token = null, $parent_id = 0, $filter = [], $sort = 'sortn')
    {
        ...
        if (isset($filter['mobile_public'])){
            $mobile_config = Loader::byModule('mobilesiteapp');
