...
class PhotoBlock extends  \RS\Csv\Preset\AbstractPreset
{
    ...
    */
    function __construct($options)
    {
       ...
       $this->range = range(0,$this->getMaxPhotos()-1); //Диапозон выборки колонок с фото от 1 до 5
    }
    ...
    */        
    ...
    /**
     * Устанавливает максимальное количество фото
     *
     * @param integer $n
     */
    function setMaxPhotos($n)
    {
        $this->max_photos = $n;
    }

    /**
     * Возвращает максимальное количество фото
     */
