...
class File extends ConfigObject
{
    function _init()
    {
        parent::_init()->append([
            ...
            'max_photos' => New Type\Integer([
                'description' => t('Максимальное количество фотографий товара'),
            ]),
            'max_categories' => New Type\Integer([
                'description' => t('Максимальное количество категорий товара'),
            ])
        ]);
    }
}
