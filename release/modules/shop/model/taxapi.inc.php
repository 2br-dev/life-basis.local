...
class TaxApi extends EntityList
{
    ...
    const TAX_NDS_5 = 'nds_5';
    const TAX_NDS_7 = 'nds_7';
    const TAX_NDS_10 = 'nds_10';
    const TAX_NDS_20 = 'nds_20';
    const TAX_NDS_105 = 'nds_105';
    const TAX_NDS_107 = 'nds_107';
    ...
    public static function getRightNds(array $taxes, Address $address)
    {
        ...
        if (!empty($tax_rate)) {
            switch((int) $tax_rate){
                case 5:
                    $tax_id = ($tax['nds_settlement_rate']) ? self::TAX_NDS_105 : self::TAX_NDS_5;
                    break;
                case 7:
                    $tax_id = ($tax['nds_settlement_rate']) ? self::TAX_NDS_107 : self::TAX_NDS_7;
                    break;
                case 10:
                    $tax_id = ($tax['nds_settlement_rate']) ? self::TAX_NDS_110 : self::TAX_NDS_10;
                    break;
                case 20:
                    $tax_id = ($tax['nds_settlement_rate']) ? self::TAX_NDS_120 : self::TAX_NDS_20;
                    break;
                case 0:
