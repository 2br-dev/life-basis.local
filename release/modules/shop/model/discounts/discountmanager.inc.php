...
/**
 * Класс, отвечает за применение скидок к корзине из различных источников
 * Реализует стратегию комбинированного применения скидок
 */
class DiscountManager
{
    ...
    public function getCartItemBaseCost(AbstractCartItem $cart_item): float
    {
        ...
        return round($single_cost * $cart_item['amount'], 2);
    }
