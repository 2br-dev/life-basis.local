    ...
    implements \Alerts\Model\Types\InterfaceEmail, \Alerts\Model\Types\InterfaceSms
{
    ...
    */
    ...
    {
        return t('Трек номер (покупателю)');
    } 
    ...
    */
    function getNoticeDataEmail()
    {
        ...
        $email_to_user->subject  = t('Трек номер заказа N%0 на сайте %1', [$this->order['order_num'], \RS\Http\Request::commonInstance()->getDomainStr()]);
