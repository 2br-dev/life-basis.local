...
class Cdek extends AbstractType implements interfaceIonicMobile
{
    ...
    protected function requestGetCallCourier($call, \Shop\Model\Orm\Order $order)
    {
        ...
        if (empty($call['use_admin'])) { //Если свой телефон
        ...
        //Адрес
        $sxml->Call->Address['Street'] = $call['SendStreet'];
        $sxml->Call->Address['House']  = $call['SendHouse'];
        $sxml->Call->Address['Flat']   = $call['SendFlat'];
