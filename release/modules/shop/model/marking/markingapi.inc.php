...
class MarkingApi extends BaseModel
{
    ...
    public static function getMarkedClasses()
    {
        ...
        if ($classes === null) {
            $classes = [];
            $classes_list = [
                new MarkedClasses\MarkedClassCommon('antiseptik', t('Антисептики'), '444d'),
                new MarkedClasses\MarkedClassCommon('medicine', t('Лекарства'), '0003'),
                new MarkedClasses\MarkedClassCommon('water', t('БАД'), '0009'),
                new MarkedClasses\MarkedClassCommon('babychair', t('Кресла коляски'), '444d'),
                new MarkedClasses\MarkedClassCommon('velo', t('Велосипеды'), '444d'),
                new MarkedClasses\MarkedClassCommon('alcohol', t('Пиво и слабоалкогольные напитки'), '0006'),
                new MarkedClasses\MarkedClassCommon('water', t('Упакованная вода'), '0009'),
                new MarkedClasses\MarkedClassCommon('clothes', t('Легкая промышленность. Предметы одежды, бельё постельное, столовое, туалетное и кухонное'), '1411'),
                ...
                new MarkedClasses\MarkedClassMilk('milk', t('Молочная продукция'), '0008'),
                new MarkedClasses\MarkedClassTobacco('tobacco', t('Табак'), '0005'),
    ...
    public static function handbookUseIdTitle()
    {
        ...
        if ($titles === null) {
            $titles = [
                ...
                self::USE_ID_OTHER => t('Остальные данные DataMatrix, после серийного номера')
            ];
        }
        return $titles;
    }
