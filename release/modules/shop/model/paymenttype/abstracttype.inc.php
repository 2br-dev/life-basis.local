...
abstract class AbstractType
{
     ...
     *
     * @param Order $order - объект заказа
     * @param $data - массив с данными, необходимыми для данной операции. Если не передан, то оплата будет извлекать эти данные из GET или POST
     */
    public function actionOrderQuery(Order $order, $data = [])
    {}
    ...
    {
        return RouterManager::obj()->buildAbsoluteUrl($relative_url);
    }
    ...
    protected static function handbookNds()
    {
        static $nds = [
            ...
            TaxApi::TAX_NDS_5 => TaxApi::TAX_NDS_5,
            TaxApi::TAX_NDS_7 => TaxApi::TAX_NDS_7,
            TaxApi::TAX_NDS_10 => TaxApi::TAX_NDS_10,
            TaxApi::TAX_NDS_20 => TaxApi::TAX_NDS_20,
            TaxApi::TAX_NDS_105 => TaxApi::TAX_NDS_105,
            TaxApi::TAX_NDS_107 => TaxApi::TAX_NDS_107,
     ...
     * @return string
     */
    public function getClientSiteAppAdditionalHTML(Order $order, Payment $payment)
    {
        return '';
    }
}
