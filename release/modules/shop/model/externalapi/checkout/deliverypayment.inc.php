    ...
    */
    ...
    {   
        ...
        if (!$this->order->hasError()){
           ...
           $response['response']['next_step']['cartdata'] = ApiUtils::fillProductItemsData($this->order);
           
           // Фиксация события "Выбран способ оплаты" для статистики
           EventManager::fire('statistic', ['type' => StatisticEvents::TYPE_SALES_SELECT_DELIVERY]);
           EventManager::fire('statistic', ['type' => StatisticEvents::TYPE_SALES_SELECT_PAYMENT_METHOD]);
        }
