 ...
 * @property integer $public Отображать для выбора в заказе
    ...
    function _init()
    {
        parent::_init()->append([
            ...
            'public' => new Type\Integer([
                'description' => t('Отображать для выбора в заказе'),
                'hint' => t('С помощью данной опции можно оставить только те статусы для выбора, которые могут быть установлены менеджерами вашей системы.'),
                'checkboxView' => [1, 0],
                'default' => 1,
                'allowEmpty' => false
            ]),
