...
class Transaction extends OrmObject
{
    ...
    {
        if (!empty($this['extra'])) {
            $this['extra_arr'] = unserialize((string)$this['extra']) ?: [];
        }
    }
    ...
    public function getProcessors()
    {
        ...
        $processors = explode(',', (string)$this['processors']);
     ...
     * @return string[]
     */
    public static function handbookReceipt(): array
    {
        return [
            ...
            self::RECEIPT_REFUND_SUCCESS => t('Чек возврата получен'),
