 ...
 * @property array $show_on_warehouses Показывать в магазинах
 * @property string $_show_on_warehouses Показывать в магазинах в сериализованном виде
...
class Payment extends OrmObject
{
    ...
    function _init()
    {
        parent::_init()->append([
            t('Основные'),
                ...
                'admin_suffix' => new Type\Varchar([
                    ...
                    'hint' => t('Отображается только в диалогах административной части<br>
                                    используйте если у вас есть оплаты с одинаковым названием')
                ]),
            ...
            t('Дополнительные условия показа'),
                ...
                'show_on_warehouses' => new Type\ArrayList([
                    'description' => t('Показывать в магазинах'),
                    'hint' => t('Данная настройка актуальна только для типа расчета доставки "Самовывоз". <br>Удерживая CTRL, можно выбрать несколько полей.'),
                ...
                '_show_on_warehouses' => new Type\Text([
                    'description' => t('Показывать в магазинах в сериализованном виде'),
                    'visible' => false
                ]),
    ...
    function beforeWrite($flag)
    {
        ...
        $this['_show_on_warehouses'] = serialize($this['show_on_warehouses']);
    ...
    function afterObjectLoad()
    {
        ...
        $this['show_on_warehouses'] = @unserialize((string)$this['_show_on_warehouses']) ?: [];
    }
