...
abstract class AbstractCartItem extends AbstractObject
{
    ...
    public function afterObjectLoad()
    {
        ...
        $this['extra_arr'] = (isset($this['extra'])) ? @unserialize((string)$this['extra']) : [];
    }
    ...
    protected function initDiscounts(): void
    {
        if ($this->discounts === null) {
            ...
            foreach ($discounts_data as $item) {
                if ($item instanceof CartItemDiscount) {
                    $item = $item->saveInArray();
                }
    ...
    /**
     * Возвращает сумму скидки на данную позицию, если эта скидка добавлена как разница от старой цены
     *
     * @return float
     */
    public function getOldCostDiscount()
    {
