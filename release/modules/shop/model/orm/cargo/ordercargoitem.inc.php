 ...
 * @property integer $order_cargo_id ID грузоместа в заказе
 * @property string $order_item_uniq Товарная позиция
 * @property integer $order_item_uit_id Идентификатор маркировки
...
class OrderCargoItem extends OrmObject
{
    ...
    function _init()
    {
        ...
        $this->addIndex(['order_id'], self::INDEX_KEY);
    }
