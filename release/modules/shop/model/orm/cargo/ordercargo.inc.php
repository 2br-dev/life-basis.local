 ...
 * @property string $title Название коробки
 * @property integer $width Ширина в мм
 * @property integer $height Высота в мм
 * @property integer $dept Глубина в мм
 * @property integer $weight Вес коробки
 * @property string $extra Произвольные данные
 * @property array $extra_arr Массив произвольных данных
 * @property array $products Товары, входящие в данное грузовое место
 * --\--
 */
class OrderCargo extends OrmObject
{
    ...
    /**
     * Возвращает ширину грузового места
     *
     * @param $dimension_unit - единица измерения, константа self::DIMENSION_UNIT_...
     * @return integer
     */
    public function getWidth($dimension_unit = self::DIMENSION_UNIT_MM)
    {
        return $this->convertDimensions($this['width'], $dimension_unit);
    }

    /**
     * Возвращает высоту грузового места
     *
     * @param $dimension_unit - единица измерения, константа self::DIMENSION_UNIT_...
     * @return float|int
     */
    public function getHeight($dimension_unit = self::DIMENSION_UNIT_MM)
    {
        return $this->convertDimensions($this['height'], $dimension_unit);
    }

    /**
     * Возвращает глубину грузового места
     *
     * @param $dimension_unit - единица измерения, константа self::DIMENSION_UNIT_...
     * @return float|int
     */
    public function getDept($dimension_unit = self::DIMENSION_UNIT_MM)
    {
        return $this->convertDimensions($this['dept'], $dimension_unit);
    }

    /**
     * Конвертирует значение из миллиметров в заданную величину
     *
     * @param $value_in_mm
     * @param $dimension_unit - единица измерения, константа self::DIMENSION_UNIT_...
     *
     * @return float|int
     */
    protected function convertDimensions($value_in_mm, $dimension_unit)
    {
        $rates = [
        ...
        return $value_in_mm/$rates[$dimension_unit];
    }
}