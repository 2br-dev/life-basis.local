...
{hook name="shop-notice-desktopcheckout:userblock" title="{t}Заказ оформлен:блок пользователю{/t}" order=$order}
...
{hook name="shop-notice-desktopcheckout:infoblock" title="{t}Заказ оформлен:блок информации{/t}" order=$order}
<table class="table table-striped">
...
{if $order.delivery}
    <h2>{t}Доставка{/t}</h2>
    {hook name="shop-notice-desktopcheckout:deliveryblock" title="{t}Заказ оформлен:блок доставки{/t}" order=$order}
    <table class="table table-striped">
        <tr>
            <td width="50%" >
                {t}Тип{/t}
...
{if $order.payment}
    <h2>{t}Оплата{/t}</h2>
    {hook name="shop-notice-desktopcheckout:paymentblock" title="{t}Заказ оформлен:блок оплата{/t}" order=$order}
    <table class="table table-striped">
            <tr>
                <td width="50%" >
                    {t}Тип{/t}
...
<table cellpadding="5" border="1" bordercolor="#969696" class="w-100">
    ...
    <tbody>
        {hook name="shop-notice-desktopcheckout:productblock" title="{t}Заказ оформлен:блок товара{/t}" order=$order}
    ...
    <tfoot>
        {hook name="shop-notice-desktopcheckout:totalblock" title="{t}Заказ оформлен:блок итого{/t}" order=$order}
        <tr class="last">
