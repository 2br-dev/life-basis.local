...
{block name="content"}
    ...
    {hook name="shop-notice-toadmincheckout:userblock" title="{t}Заказ оформлен:блок пользователю{/t}" order=$order}
    ...
    {hook name="shop-notice-toadmincheckout:infoblock" title="{t}Заказ оформлен:блок информации{/t}" order=$order}
        <table class="order-table">
    ...
    {if $order.delivery}
        ...
        {hook name="shop-notice-toadmincheckout:deliveryblock" title="{t}Заказ оформлен:блок доставки{/t}" order=$order}
    ...
    {if $order.payment}
        ...
        {hook name="shop-notice-toadmincheckout:paymentblock" title="{t}Заказ оформлен:блок оплата{/t}" order=$order}
            <table class="order-table">
    ...
    <table cellpadding="5" border="1" bordercolor="#969696" style="border-collapse:collapse; border:1px solid #969696">
        ...
        <tbody>
            {hook name="shop-notice-toadmincheckout:productblock" title="{t}Заказ оформлен:блок товара{/t}" order=$order}
        ...
        <tfoot>
            {hook name="shop-notice-toadmincheckout:totalblock" title="{t}Заказ оформлен:блок итого{/t}" order=$order}
                <tr class="last">
