...
{block name="content"}
    ...
    {hook name="shop-notice-touserassignorder:userblock" title="{t}Вам назначен заказ:блок пользователя{/t}"  order=$order}
    ...
    {hook name="shop-notice-touserassignorder:infoblock" title="{t}Вам назначен заказ:блок информации{/t}"  order=$order}
        <table class="order-table">
    ...
    {if $order.delivery}
        ...
        {hook name="shop-notice-touserassignorder:deliveryblock" title="{t}Вам назначен заказ:блок доставка{/t}"  order=$order}
    ...
    {if $order.payment}
        ...
        {hook name="shop-notice-touserassignorder:paymentblock" title="{t}Вам назначен заказ:блок оплата{/t}"  order=$order}
            <table class="order-table">
    ...
    <table cellpadding="5" border="1" bordercolor="#969696" style="border-collapse:collapse; border:1px solid #969696">
        ...
        <tbody>
            {hook name="shop-notice-touserassignorder:productblock" title="{t}Вам назначен заказ:блок товара{/t}" order=$order}
        ...
        <tfoot>
            {hook name="shop-notice-touserassignorder:totalblock" title="{t}Вам назначен заказ:блок итого{/t}" order=$order}
            <tr class="last">
