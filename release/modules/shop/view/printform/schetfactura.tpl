    ...
    <DIV id="id_1">
        ...
        <table cellpadding=0 cellspacing=0 class="t0" style="margin: 0">
            ...
            {foreach from=$product_arr key=n item=item name=foo}
                ...
                <TD colspan="6" class="tr11 td26 border-right"><P class="p2 center">{floatval($item.single_cost_noformat)}</P></TD>
                ...
                <TD colspan="2" class="tr11 td14 border-right"><P class="p2 center">{round(floatval($taxes.items[$n].taxes.rate), 2)}%</P></TD>
        ...
        {/foreach}
            {if $taxes.delivery}
                <TR>
                    ...
                    <TD colspan="2" class="tr11 td12 border-right"><P class="p2 center" contenteditable="true">&nbsp;</P></TD>
                    <TD colspan="2" class="tr11 td14 border-right"><P class="p2 center">{round(floatval($taxes.delivery.tax_rate), 2)}%</P></TD>
