...
<DIV id="page_2">
    ...
    <TABLE cellpadding=0 cellspacing=0 class="t2">
        ...
        <TR class="header {if $smarty.foreach.foo.last} border-bottom {/if} " >
            ...
            <TD class="tr1 td147">
                <P class="p1">
                    {$item.cartitem.title}{if $item.cartitem.model && $item.cartitem.title != $item.cartitem.model}, {$item.cartitem.model}{/if}{if $item.cartitem.barcode}, {$item.cartitem.barcode}{/if}
                </P>
            </TD>
