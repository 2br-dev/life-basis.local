...
{block "body"}
    <div id="pvzMapWrapper" ontouchmove="event.preventDefault();" class="selectPvz {if empty($delivery_pvz_list)}selectPvz_empty{else}rs-selectPvz{/if}" data-pvz-json='{$pvz_json}'>
