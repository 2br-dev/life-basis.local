{if $elem.id > 0 && $rights[Shop\Config\ModuleRights::RIGHT_CARGO_READING]}
    <div>
        <h3>{t}Грузовые места{/t}</h3>
        {hook name="shop-orderview:cargos" title=t('Редактирование заказа(админ. панель):Грузовые места')}
