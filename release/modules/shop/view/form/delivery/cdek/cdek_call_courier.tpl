        ...
        <div class="cdekCallCourier">
            ...
            <div style="display:flex">
                <div class="form-group m-r-10">
                    <p>{t}Улица забора{/t}:</p>
                    <input type="text" name="call[SendStreet]">
                </div>
                <div class="form-group m-r-10">
                    <p>{t}Дом забора{/t}:</p>
                    <input type="text" name="call[SendHouse]" size="5">
                </div>
                <div class="form-group">
                    <p>{t}Квартира забора{/t}:</p>
                    <input type="text" name="call[SendFlat]" size="5">
                </div>
            </div>
            <div class="form-group">
