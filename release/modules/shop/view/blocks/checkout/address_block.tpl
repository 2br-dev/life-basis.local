                            ...
                            <div class="{if $field_name == 'addr_zipcode'}col-xl-3 col-sm-3 col-lg-12{else}col-9{/if}">
                                ...
                                {if $field_name == 'addr_address'}
                                    <div class="rs-checkout_addressAddressInputWrapper position-relative">
                                        <input class="form-control rs-checkout_triggerUpdate rs-checkout_addressAddressInput {if $shop_config.require_choose_address && !empty($main_config.dadata_api_key)}rs-checkout_requireSelectAddress{/if}" type="text" name="{$field_name}" value="{$order[$field_name]}" autocomplete="off">
                                    </div>
                                {else}
