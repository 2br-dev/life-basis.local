...
use Article\Model\microdata\MicrodataArticle;
...
class View extends Front
{
    ...
    function actionIndex()
    {
        ...
        $dir = $category > 0 ? $this->cat_api->getById($category) : new ArticleCategory;
        if ($dir['id']) {
        ...
        //Добавляем микроразметку для страницы статьи
        Application::getInstance()->microdata->addMicrodata(new MicrodataArticle($article));
