        ...
        if ($product['id']){
            ...
            if (!empty($recommended)){
                ...
                foreach ($list as &$product){
                    ...
                    $offers_info = \Catalog\Model\ApiUtils::fillOffersFromJSON($recommended[$product['id']]);
                    $product['offers_list_info'] = $offers_info ?: \Catalog\Model\ApiUtils::getOffersInfo($recommended[$product['id']], ['stock', 'costs']);
                }
