...
*/
class Clear extends \ExternalApi\Model\AbstractMethods\AbstractAuthorizedMethod
{
    ...
    * @example GET api/methods/favorite.remove?token=2bcbf947f5fdcd0f77dc1e73e73034f5735de486
    * Ответ
    * <pre>
    * {
    *     "response": {
    ...
    */
    function process($token = null)
    {
        ...
        $favoriteapi->removeAllFromFavorite();
