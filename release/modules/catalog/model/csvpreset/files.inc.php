...
class Files extends AbstractPreset
{
    ...
    {
        if (isset($this->row['files']) && !empty($this->row['files'])) {
            /** @var Base $base_preset */
            ...
            if ($object['id'] ?? false){
                ...
                $acces_array = explode(';', $this->row['files_types'] ?? '');
                ...
                foreach ($docs_array as $index => $doc_url) {
                    ...
                    if (!empty($doc_url)) {
                        ...
                        if (!empty($acces_array[$index])) {
                            $file_types->setDefaultAccessType(trim($acces_array[$index]));
                        } else {
                            $file_types->setDefaultAccessType($config['csv_file_upload_access']);
                        }
