 ...
 * @property string $is_spec_dir Это спец. категория?
...
class Dir extends \RS\Orm\OrmObject
{
    ...
    {                
        parent::_init()->append([
            t('Основные'),
                    ...
                    'is_spec_dir' => new Type\Varchar([
                        'maxLength' => '1',
                        'description' => t('Это спец. категория?'),
                        'visible' => false,
                        'rootVisible' => false,
        ...
        $this->addIndex(['site_id', 'is_spec_dir']);
    ...
    */
    function afterObjectLoad()
    {
        if (!empty($this['recommended'])) {
            $this['recommended_arr'] = @unserialize((string)$this['recommended']);
        }
        if (!empty($this['concomitant'])) {
            $this['concomitant_arr'] = @unserialize((string)$this['concomitant']);
        }
        ...
        if ($this['is_virtual']) {
            $this['virtual_data_arr'] = @unserialize((string)$this['virtual_data']) ?: [];
        }

        $this['in_list_properties_arr'] = @unserialize((string)$this['in_list_properties']);
    }
