...
class ItemValue extends \RS\Orm\OrmObject
{
    ...
    */
    ...
    /**
     * Возвращает либо один массив со всеми свойствами значения характеристики,
     * либо массив массивов
     *
     * @param integer | array $ids - один ID или список ID
     * @return array
     */
    public static function getValueDataById($ids)
    {
        static $cache = [];
        ...
        $values = array_intersect_key($cache, array_flip($ids_arr));
        return is_array($ids) ? $values : ($values[$ids] ?: []);
    }
}
