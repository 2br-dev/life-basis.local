...
class Brand extends \RS\Orm\OrmObject
{
    ...
    */
    ...
    /**
     * Возвращает URL списка товаров с установленным фильтром по бренду
     *
     * @param Dir|null $category Категория, ссылку на которую нужно сформировать. По умолчанию - все.
     * @param bool $absolute Если true, то ссылка будет абсолютной
     * @return string
     */
    function getProductsUrl(Dir $category = null, $absolute = false)
    {
        $url = Api::encodeDirFilterParamsToUrl($category, ["brand" => [$this->id]]);
