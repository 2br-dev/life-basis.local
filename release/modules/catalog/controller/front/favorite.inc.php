...
class Favorite extends \RS\Controller\Front
{
    ...
    function actionAdd(){
        ...
        $product_ids = array_map('intval', array_values($this->favoriteapi->loadInFavoriteList()));

        $this->result->setSuccess(true)
            ->addSection('products', $product_ids)
            ->addSection('count', $this->favoriteapi->getFavoriteCount());
        return $this->result;
    }
