...
class WareHouseCtrl extends Crud
{
    ...
    public function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element([
            'Columns' => [
                ...
                new TableType\StrYesno('default_house', t('Склад по умолчанию?'), ['Sortable' => SORTABLE_BOTH]),
                new TableType\StrYesno('public', t('Публичный'), ['Sortable' => SORTABLE_BOTH]),
                new TableType\StrYesno('checkout_public', t('Пункт самовывоза'), ['Sortable' => SORTABLE_BOTH]),
            ...
            'Container' => new Filter\Container([
                'Lines' => [
                    new Filter\Line(['items' => [
                        ...
                        new Filter\Type\Select('default_house', t('Склад по умолчанию'), [
                            '' => t('Не важно'),
                            '1' => t('Да'),
                            '0' => t('Нет')
                        ]),
                        new Filter\Type\Select('public', t('Публичный'), [
                            '' => t('Не важно'),
                            '1' => t('Да'),
                            '0' => t('Нет')
                        ]),
                        new Filter\Type\Select('checkout_public', t('Как пункт самовывоза'), [
                            '' => t('Не важно'),
                            '1' => t('Да'),
                            '0' => t('Нет')
                        ]),
        ...
        $helper->setCategoryFilter(new Filter\Control([
            ...
            'filterVar' => 'c',
            'Caption' => t('Поиск по группам складов')
        ]));
    ...
    {
        $this->getHelper()->setTopTitle($primaryKey ? t('Редактировать склад {title}') : t('Добавить склад'));
