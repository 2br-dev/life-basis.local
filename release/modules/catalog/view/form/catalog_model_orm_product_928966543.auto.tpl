        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        <div class="tab-pane active" id="catalog-product-tab0" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__date_of_update->getTitle()}&nbsp;&nbsp;{if $elem.__date_of_update->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__date_of_update->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__date_of_update->getRenderTemplate() field=$elem.__date_of_update}</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__sale_status->getTitle()}&nbsp;&nbsp;{if $elem.__sale_status->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__sale_status->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__sale_status->getRenderTemplate() field=$elem.__sale_status}</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__exchange_dont_update_price->getTitle()}&nbsp;&nbsp;{if $elem.__exchange_dont_update_price->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__exchange_dont_update_price->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__exchange_dont_update_price->getRenderTemplate() field=$elem.__exchange_dont_update_price}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="catalog-product-tab8" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__longtitle->getTitle()}&nbsp;&nbsp;{if $elem.__longtitle->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__longtitle->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__longtitle->getRenderTemplate() field=$elem.__longtitle}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__show_main->getTitle()}&nbsp;&nbsp;{if $elem.__show_main->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__show_main->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__show_main->getRenderTemplate() field=$elem.__show_main}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="catalog-product-tab9" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__yd_disabled->getTitle()}&nbsp;&nbsp;{if $elem.__yd_disabled->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__yd_disabled->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__yd_disabled->getRenderTemplate() field=$elem.__yd_disabled}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__yd_min_order->getTitle()}&nbsp;&nbsp;{if $elem.__yd_min_order->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__yd_min_order->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__yd_min_order->getRenderTemplate() field=$elem.__yd_min_order}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="catalog-product-tab12" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__country_code->getTitle()}&nbsp;&nbsp;{if $elem.__country_code->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__country_code->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__country_code->getRenderTemplate() field=$elem.__country_code}</td>
                                </tr>
