...
<div class="virtual-dir" id="virtualDir" data-urls='{ "addPropertyUrl": "{adminUrl do="addVirtualDirPropery"}" }'>
    <div class="vt-switcher">
        ...
        <span class="help-icon" title='{t}При включенной опции категория станет "виртуальной". <br>Товары, подобранные в виртуальных категориях, не попадают в фид при экспорте товаров{/t}'>?</span>
        <div class="fieldhelp">
