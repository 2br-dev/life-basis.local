{foreach from=$photo_list item=photo key=key}
    <li class="photo-one" data-id="{$photo.id}">
        ...
        <div class="move">
            ...
            <a class="flip horizontal" title="{t}Отразить по горизонтали{/t}" href="{adminUrl mod_controller="photo-blockphotos" do=false pdo="flip" photoid=$photo.id direction="horizontal"}"></a>
            ...
            <a class="flip vertical" title="{t}Отразить по вертикали{/t}" href="{adminUrl mod_controller="photo-blockphotos" do=false pdo="flip" photoid=$photo.id direction="vertical"}"></a>
        </div>
