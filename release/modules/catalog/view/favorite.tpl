            ...
            <div class="col">
                <div class="catalog-bar">
                    ...
                    <ul class="catalog-view-as ms-3">
                        <li>
                            <a class="rs-list-view-change {if $view_as == 'blocks'}view-as_active{/if}" data-view="block" title="{t}Товары блоками{/t}">
                        ...
                        <li>
                            <a class="rs-list-view-change {if $view_as == 'table'}view-as_active{/if}" data-view="table" title="{t}Товары в строку{/t}">
                                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
