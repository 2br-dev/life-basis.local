{if $categories}
    <div {if $THEME_SETTINGS.top_category_mobile_view != 'wrap'}class="re-container-mob"{/if}>
        <div class="row row-cols-lg-4 row-cols-md-3 {if $THEME_SETTINGS.top_category_mobile_view != 'wrap'}row-cols-auto{else}row-cols-2{/if} g-3 g-xl-4 re-container-mob__inner">
