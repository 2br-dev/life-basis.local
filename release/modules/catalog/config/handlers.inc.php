...
use Crm\Model\Autotask\RuleIfOneClick;
...
class Handlers extends HandlerAbstract
{
    ...
    /**
     * Добавляет в CRM задачи возможность связи с покупкой в 1 клик
     *
     * @param array $link_types
     * @return array
     * @throws RSException
    ...
    public static function ormAfterLoadUsersUser($params)
    {
        ...
        $user['user_cost'] = @unserialize((string)$user['cost_id']) ?: [];
    }
    ...
    public static function ormAfterLoadUsersUserGroup($params)
    {
        ...
        $group['user_cost'] = @unserialize((string)$group['cost_id']) ?: [];
    }
