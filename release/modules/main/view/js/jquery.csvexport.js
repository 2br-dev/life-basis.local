    ...
    $.fn.csvExport = function( method ) {
        ...
        return this.each(function() {
            ...
            saveMap = function() {
                ...
                var format = $(data.options.format, $this).val();
                if (title) {
            ...
            selectMap = function() {
                if ($(this).val() > 0) {
                    ...
                    for(var key in map['columns']) {
                        $('option[value="'+key+'"]', source).appendTo(destination);
                    }
                    $(data.options.format, $this).val(map['format']);
                }
            };
        ...
        return this.each(function() {
            ...
            selectMap = function() {
                if ($(this).val() > 0) {
                    ...
                    for(var key in map['columns']) {
                        $(data.options.destination + '[name="columns['+key+']"]', $this).val(map['columns'][key]);
                    }
                }
            };
