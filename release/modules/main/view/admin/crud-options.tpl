                    ...
                    <div class="tools-column fullheight">
                        <div class="controller_info">
                            ...
                            <ul class="list-with-help">
                                ...
                                <li><a class="crud-get" href="{adminUrl do="resetAuthTry"}" style="text-decoration:underline">{t}Сбросить счетчик попыток авторизации{/t}</a>
                                    <div class="tool-descr">{t}Сбрасывает счетчик неудачных попыток ввода пароля для всех IP-адресов{/t}</div>
                                </li>
                                <li><a class="crud-get" href="{adminUrl do="unlockCron"}" style="text-decoration:underline">{t}Разблокировать Cron{/t}</a>
                                    <div class="tool-descr">{t}Удалить файл блокировки планировщика заданий Cron{/t} (/storage/locks/cron)</div>
                                </li>
                                ...
                                <li><a class="crud-get" href="{adminUrl do="OldTemplatePatch"}" style="text-decoration:underline">{t}Установить патч для шаблонов ReadyScript 5.x{/t}</a>
                                    <div class="tool-descr">{t}Копирует в тему(без замены файлов) старые tpl, js, css файлы, которые были в модулях ReadyScript 5.x{/t}</div>
                                </li>
                                <li><a class="crud-get" href="{adminUrl do="ConvertToUtf8mb4"}" style="text-decoration:underline">{t}Конвертировать кодировку таблиц в UTF8mb4{/t}</a>
                                    <div class="tool-descr">{t}Выполнит попытку изменения кодировки таблиц в utf8mb4. Данная кодировка поддерживает Emoji{/t}</div>
                                </li>
                            </ul>
                        </div>
                    </div>
