...
class ModuleRights extends DefaultModuleRights
{
    ...
    const RIGHT_VIEW_ICON_ALERTS = 'view_icon_alerts';
    const RIGHT_VIEW_ICON_NEWS = 'view_icon_news';
    ...
    protected function getSelfModuleRights()
    {
        return [
            new RightGroup('main_general', t('Разное'), [
                ...
                new Right(self::RIGHT_CLEAN_CACHE, t('Возможность сбросить кэш')),
                new Right(self::RIGHT_VIEW_LOGS, t('Просмотр логов')),
                new Right(self::RIGHT_VIEW_ICON_ALERTS, t('Показ кнопки "Уведомления"')),
                new Right(self::RIGHT_VIEW_ICON_NEWS, t('Показ кнопки "Новости"')),
            ]),
