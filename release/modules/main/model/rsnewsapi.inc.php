...
class RsNewsApi
{
    ...
    {
        $response = Manager::obj()
            ->expire(60*60*4) //Выполняем запрос не чаще чем раз в 4 часа.
            ->tags(self::CACHE_TAG_NEWS)
            ->request([$this, 'requester'], 'rsNews.checkNew', [], $this->user_id);
    ...
    public function markAsViewed($id)
    {
        ...
        Manager::obj()->invalidateByTags(self::CACHE_TAG_NEWS);
        return $unread_count;
    }
     ...
     * @return mixed
     */
    public function requester($method, $params = [])
    {
