...
class License extends AbstractObject
{
    ...
    function beforeWrite($flag)
    {
        if ($flag != self::UPDATE_FLAG) {
            ...
            //Проверяем установлен ли другой основной ключ(не временный).
    ...
    */
    ...
    /**
     * Заполняет текущий объект предыдущими данными по активации
     *
     * @return void
     */
    function fillDefaultActivationValue()
    {
        //Подставляем сохраненные ранее данные, если таковые имеются
