...
class RsRequestGate extends Front
{
    ...
    function init()
    {
        ...
        $domain_sign_sha256 = base64_decode($this->url->request('domain_sign_sha256', TYPE_STRING));
        ...
        //Проверяем подпись
        $ok = openssl_verify($check_string, $domain_sign_sha256, $pubkeyid, OPENSSL_ALGO_SHA256);
