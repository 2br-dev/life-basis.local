...
class LogView extends Front
{
                ...
                new TableType\Actions('id', [
                    ...
                    new TableType\Action\DropDown([
                        [
                            'title' => t('Удалить'),
                            'attr' => [
                                '@href' => $this->router->getAdminPattern('delete', [':log_class' => '@log_class', ':site_id' => '@site_id']),
                                'class' => 'crud-get',
                                'data-confirm-text' => t('Вы действительно желаете удалить лог?')
                            ]
                        ]
                    ]),
                ])
    ...
    public function actionDelete()
    {
        ...
        return $this->result->setSuccess(false)->addEMessage(t('Файл не найден'));
    }
}
