...
class Csv extends AdminFront
{
    ...
    function actionExportCsv()
    {
        ...
        if ($csv_schema = AbstractSchema::getByShortName($schema)) {
            ...
            $format = $this->url->request('format', TYPE_STRING, \RS\Csv\Format\Type\Csv::getId());
            ...
            $this->view->assign([
                ...
                'formats' => DataProcessor::getFormatTypeTitles()
            ]);
    ...
    function actionDoExport()
    {
        ...
        if (isset($_SESSION['export_data'])) {
            ...
            $csv_schema->setFormat($_SESSION['export_data']['format']);
            $csv_schema->setAction('export');
            $csv_schema->export();
        } else {
    ...
    */
    ...
    function actionSaveMap()
    {
        ...
        $format = $this->url->convert($this->url->request('format', TYPE_STRING), array_keys(DataProcessor::getFormatTypes()));
