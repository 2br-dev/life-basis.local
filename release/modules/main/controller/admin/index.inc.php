...
class Index extends AbstractController
{
    ...
    {
        if (AppAuth::getCurrentUser()->checkModuleRight('main', ModuleRights::RIGHT_CLEAN_CACHE)) {
    ...
    protected function authorizeByMobileClient()
    {
        if (Manager::staticModuleExists('externalapi')) {
            ...
            if ($token['user_id'] && $token->getUser()->isAdmin()) {
                AppAuth::setCurrentUser($token->getUser());
            }
        }
    }
}
