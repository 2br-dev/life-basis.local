            ...
            switch ($form_field['show_type']) {
                ...
                case FormFieldItem::SHOW_TYPE_LIST:
                    ...
                    if ($form_field['required']) {
                        $list_of_values = $form_field->getArrayValuesFromString();
                        if ($list_of_values && $value == $list_of_values[0]) {
                            $value = '';
                        }
                    }
                ...
                default:  //По умолчанию если не файл и не Email
                    ...
                    if (!empty($form_field['use_mask'])) {
                        if (!preg_match('%' . $form_field['mask'] . '%u', $value)) { //Если не прошло валидацию
