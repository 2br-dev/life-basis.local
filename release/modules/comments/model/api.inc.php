            ...
            implements HasMeterInterface
{
    ...
    */
    ...
    /**
     * Обновляет рейтинг товаров при массовом редактировании
     *
    ...
    {
        $result = parent::multiUpdate($data, $ids);
        if ($result) {
            foreach ($ids as $comment) {
                $comment = new Comment($comment);
                $this->recountItemRatingByComment(new Product($comment['aid']), $comment);
            }
        }
        return $result;
    }
