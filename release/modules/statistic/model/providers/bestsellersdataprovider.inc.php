    ...
    public function getTableStructure()
    {
        ...
        $this->table  = new TableElement([
            'Columns' => [
                ...
                new UnitColumn('cnt', t('Кол-во'), ['unit' => $this->getPlotUnit()]),
            ...
            'Container' => new Filter\Container( [
                'Lines' =>  [
                    new Filter\Line( ['items' => [
                            ...
                            new \Statistic\Model\HtmlFilterType\ProductSelect('brand_id', t('Бренд'), ['' => t('-Не выбрано-')] + \Catalog\Model\BrandApi::staticSelectList(false), ['FieldPrefix' => 'P']),
                    ]])
                ]
            ]),
