...
class Dashboard extends \RS\Controller\Admin\Front
{
    ...
    function init()
    {
        ...
        [$this->router->getAdminUrl('edit', ['mod' => 'shop'], 'modcontrol-control')]));
    ...
    function actionIndex()
    {
        ...
        $this->helper['form'] = $this->view->fetch('%statistic%/admin/dashboard.tpl');
        $this->helper->active();
    ...
    function actionRedirectToProduct()
    {
        ...
        if ($product['id']) {
            Application::getInstance()->redirect($product->getUrl());
        }
