...
class File extends \RS\Orm\ConfigObject
{
    function _init()
    {
        parent::_init()->append([
            ...
            'pretty_print_response' => new Type\Integer([
                'description' => t('Форматировать возвращаемый JSON для удобного чтения'),
                'hint' => t('Увеличивает отдаваемый трафик примерно в 3 раза за счет дополнительных пробелов.'),
                'checkboxView' => [1, 0]
            ]),
    ...
    public static function getDefaultValues()
    {
        return parent::getDefaultValues() + [
            'tools' => [
                ...
                [
                    'url' => \RS\Router\Manager::obj()->getAdminUrl(false, [], 'externalapi-appctrl'),
                    'title' => t('Внешние приложения'),
                    'description' => t('Создайте приложение для получения доступа к методам API из внешних систем'),
                    'class' => ' '
                ],
            ]
            ];
