...
abstract class AbstractFilteredList extends AbstractAuthorizedMethod
{
    ...
    */
    ...
    protected function prepareAllowableOrderValues()
    {
        ...
        $event_result = EventManager::fire('api.'.strtolower($this->getSelfMethodName()).'.getallowableordervalues', [
            'list' => $list
        ]);
    ...
    */
    ...
    public function setFilter($dao, $filter)
    {
        ...
        EventManager::fire('api.'.strtolower($this->getSelfMethodName()).'.setFilter', [
            'method' => $this,
            'dao' => $dao,
            'filter' => $filter
        ]);
    ...
    public function setOrder($dao, $order)    
    {
        ...
        EventManager::fire('api.'.strtolower($this->getSelfMethodName()).'.setOrder', [
            'method' => $this,
            'dao' => $dao,
            'order' => $order
        ]);
