                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="100%" style="min-width:400px; padding:40px; background: #fff;">
                                    ...
                                    <td>
                                        ...
                                        <p>
                                            ...
                                            <a href="{$SITE->getRootUrl(true)}" target="_blank">
                                                {if $CONFIG.firm_name_for_notice}{$CONFIG.firm_name_for_notice}{else}{$SITE->getMainDomain(true)}{/if}
                                            </a>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="display: block; text-align: center; padding-bottom: 15px">
                                        <img src="{$SITE->getRootUrl(true)}modules/alerts/view/img/spacer.gif" width="100%" height="1" style="background: #eeeeee;"/>
                                    </td>
                                </tr>
                                <tr>
