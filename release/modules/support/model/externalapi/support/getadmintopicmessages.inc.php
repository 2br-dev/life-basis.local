...
/**
* Возвращает переписку в рамках одной темы - администратору
*/
class GetAdminTopicMessages extends AbstractAuthorizedMethod
{
    const RIGHT_LOAD = 1;
    ...
    protected function process($token, $topic_id, $sections = ['messages'])
    {
        ...
        if ($topic && $this->token->getApp()->getId() == 'store-management') {
            $result = [];
