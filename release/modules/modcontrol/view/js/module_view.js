$(function() {
    ...
    var initTabChangeLocation = function() {
        $('body')
            .off('shown.bs.tab.moduleview')
            .on('shown.bs.tab.moduleview', 'a[data-toggle="tab"]', function (e)
            {
                var anchor = '#tab-' + $(this).closest('li').index();
