...
class Events extends Crud
{
    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element([
            'Columns' => [
                ...
                new TableType\Usertpl('details', t('Детали'), '%antivirus%/admin/event_col_details.tpl', ['TdAttr' => ['class' => 'cell-small']]),
                new TableType\Yesno('viewed', t('Просмотрено'), ['toggleUrl' => $this->router->getAdminPattern('ajaxToggleViewed', [':id' => '@id']), 'Sortable' => SORTABLE_BOTH]),
                    ...
                    new TableType\Action\DropDown([
                        [
                            ...
                            'attr' => [
                                ...
                                '@href' => $this->router->getAdminPattern('recover', [':id' => '~field~']),
                            ]
                        ],
                        [
                            ...
                            'attr' => [
                                ...
                                '@href' => $this->router->getAdminPattern('delete', [':id' => '~field~']),
                            ]
                        ],
                        [
                            ...
                            'attr' => [
                                'class' => 'crud-add',
                                '@href' => $this->router->getAdminPattern('showDiff', [':id' => '~field~']),
                            ]
                        ],
                        [
                            ...
                            'attr' => [
                                'class' => 'crud-get',
                                '@href' => $this->router->getAdminPattern('ajaxExclude', [':id' => '~field~']),
                            ]
                        ],
                        [
                            ...
                            'attr' => [
                                'class' => 'crud-get',
                                '@href' => $this->router->getAdminPattern('ajaxBlockIp', [':id' => '~field~']),
                            ]
                        ],
                        [
            ...
            'Container' => new Filter\Container( [
                'Lines' =>  [
                    new Filter\Line( ['items' => [
                        new Filter\Type\Select('type', t('Тип'), [''=>t('Любой')] + Event::getTypeList()),
                        new Filter\Type\Select('component', t('Компонент'), [''=>t('Любой')] + Event::getComponentList()),
                    ]
                    ])
                ],
            ]),
        ...
        $helper->setBottomToolbar(new Toolbar\Element([
            'Items' => [
                new ToolbarButton\Button('javascript:;', t('Лечить'), ['attr'=> [
                    'class'=>'fixSelected',
                    'data-url' => $this->router->getAdminUrl('multiFix', null, 'antivirus-events'),
                ]]),
                new ToolbarButton\Button('javascript:;', t('Отметить просмотренными'), ['attr'=> [
                    'class'=>'crud-post-selected',
                    'data-url' => $this->router->getAdminUrl('multiSetViewed', null, 'antivirus-events'),
                ]]),
                new ToolbarButton\Delete(null, t('Скрыть'), ['attr' =>
                    [
    ...
    public function actionDelete()
    {
        ...
        $server_api->deleteFiles([$event->file]);
    ...
    public function actionRecover()
    {
        ...
        $server_api->recoverFiles([$event->file]);
    ...
    public function actionShowDiff()
    {
        ...
        $helper['form'] = $this->view->fetch('admin/show_diff.tpl');
    ...
    function actionMultiSetViewed()
    {
        ...
        if ($ids) {
            ...
            return $this->result->setSuccess(true)
                                ...
                                ->addMessage(t('Обновлено %0 событий', [count($ids)]));
        }
