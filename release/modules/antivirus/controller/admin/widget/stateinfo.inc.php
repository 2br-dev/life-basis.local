    ...
    function actionIndex()
    {
        ...
        $this->view->assign([
            ...
            'integrity' => [
                ...
                'event_list_url'    => $this->router->getAdminUrl('index', ['f'=> ['component'=>'integrity']], 'antivirus-events'),
            ...
            'antivirus' => [
                ...
                'event_list_url'    => $this->router->getAdminUrl('index', ['f'=> ['component'=>'antivirus']], 'antivirus-events'),
            ...
            'proactive' => [
                'event_list_url'    => $this->router->getAdminUrl('index', ['f'=> ['component'=>'proactive']], 'antivirus-events'),
            ...
            'refresh_url'       => $this->router->getAdminUrl(false, ['avdo' => $intensive ? 'indexIntensive' : null], $this->getUrlName()),
        ]);
