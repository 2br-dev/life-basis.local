...
abstract class ResumableTask
{
    ...
    public function execute()
    {
        ...
        $this->log("");
        $this->log(t('Начинаем выполнять задание с позиции %0, всего: %1, шаг: %2', [$this->position, $total_count, $this->step_size]));
        ...
        $this->log(t("Раунд завершен. Время выполнения раунда: %0 сек.", [$exec_time]));
