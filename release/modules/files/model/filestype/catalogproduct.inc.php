...
class CatalogProduct extends AbstractType
{
    ...
    */
    ...
    {
        return $this->default_access_type ?? self::ACCESS_TYPE_HIDDEN;
    }

    /**
     * Устанавливает уровень доступа к файлам по умолчанию
     *
     * @param string $access_type
     * @return void
     */
    public function setDefaultAccessType($access_type)
    {
        $this->default_access_type = $access_type;
    }
}
