...
class Index extends \RS\Orm\AbstractObject
{
    ...
    */
    ...
    {
        $engine = parent::getTableEngine();
        if (version_compare(Adapter::getVersion(), '5.6.4') < 0) {
            // MySQL 5.6.4 и ниже не поддерживает FULLTEXT index
            $engine = in_array($engine, ['MyISAM', 'Aria']) ? $engine : 'MyISAM';
        }
