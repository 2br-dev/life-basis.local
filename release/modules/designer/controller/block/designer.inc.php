...
class Designer extends Block
{
    ...
    const YA_MAP_API_SUGGEST_KEY = 'f8a155bc-1e60-47dd-bfc8-074dc86b431c';
    ...
    {
        $main_config = \RS\Config\Loader::byModule('main');
        ...
        $designer_variables['tinymce_js_url']          = \Setup::$FOLDER.\Setup::$RES_JS_FOLDER."/tiny_mce/tinymce.min.js";
        $designer_variables['yandexmap']['api_key']    = !empty($main_config['yandex_js_api_geocoder']) ? $main_config['yandex_js_api_geocoder'] : self::YA_MAP_API_KEY;
        $designer_variables['yandexmap']['api_suggest_key']    = !empty($main_config['yandex_js_api_suggest']) ? $main_config['yandex_js_api_suggest'] : self::YA_MAP_API_SUGGEST_KEY;
    ...
    private function addMenuUrlsForDesigner(&$designer_variables)
    {
        ...
        $designer_variables['mobilemenu_js_url']          = \Setup::$FOLDER.\Setup::$MODULE_FOLDER."/designer".\Setup::$MODULE_TPL_FOLDER."/js/mobilemenu/dist/mobilemenu.js";
    }
    ...
    private function addProductUrlsForDesigner(&$designer_variables)
    {
        ...
        $designer_variables['productselect_js_url']  = \Setup::$FOLDER.\Setup::$MODULE_FOLDER."/catalog/view/js/selectproduct.js";
        $designer_variables['productselect_css_url'] = \Setup::$FOLDER.\Setup::$MODULE_FOLDER."/catalog/view/css/selectproduct.css";
        $designer_variables['lightgallery_js_url']   = \Setup::$FOLDER.\Setup::$RES_JS_FOLDER."/lightgallery/lightgallery-nojquery.min.js";
        $designer_variables['lightgallery_css_url']  = \Setup::$FOLDER.\Setup::$RES_CSS_FOLDER."/common/lightgallery/css/lightgallery.min.css";
        $designer_variables['swiper_js_url']         = \Setup::$FOLDER.\Setup::$RES_JS_FOLDER."/swiper/swiper.min.js";
        $designer_variables['swiper_css_url']        = \Setup::$FOLDER.\Setup::$RES_CSS_FOLDER."/common/swiper/swiper.min.css";
    }
    ...
    private function initPublicDesigner()
    {
        ...
        $this->app->addCss(\Setup::$FOLDER.\Setup::$MODULE_FOLDER.'/designer/cache/css/block-'.$this->getModuleId().'.css', null, BP_ROOT);
        ...
        if (BlocksApi::isHaveMenuAtomInBlock($settings) && !self::$mobile_css_loaded){
            $this->app->addCss(\Setup::$FOLDER.\Setup::$MODULE_FOLDER.'/designer/cache/css/mmenu.css', null, BP_ROOT);
