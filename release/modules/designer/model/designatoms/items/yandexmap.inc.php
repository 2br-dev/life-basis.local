...
class YandexMap extends DesignAtoms\AbstractAtom {
    ...
    const API_SUGGEST_KEY = 'f8a155bc-1e60-47dd-bfc8-074dc86b431c';
    ...
    function __construct()
    {
        ...
        $suggest_key = '&suggest_apikey='.($config['yandex_js_api_suggest'] ? $config['yandex_js_api_suggest'] : self::API_SUGGEST_KEY);
        self::$public_js[] = 'https://api-maps.yandex.ru/2.1/?lang=ru_RU&apikey='.($config['yandex_js_api_geocoder'] ? $config['yandex_js_api_geocoder'] : self::API_KEY).$suggest_key;
