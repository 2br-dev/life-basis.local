...
class ImageApi extends UploadApi
{
    ...
    {
        $default_atom_image_file  = \Setup::$PATH.\Setup::$MODULE_FOLDER.'/designer'.\Setup::$MODULE_TPL_FOLDER.'/img/defaultdata/default_image.png';
    ...
    function saveAtomUploadedImageByUrl($block_id, $atom_id, $image_url)
    {
        ...
        copy($image_url, $this->original_image_storage_folder.$default_file, $context);
        copy($image_url, $this->images_dir.$default_file, $context);
