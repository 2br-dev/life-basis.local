    ...
    { 
        ...
        while(true)
        {
            ...
            while(true)
            {
                $this->keystring='';
                for($i=0; $i < $length ; $i++ )
                    $this->keystring .= mb_substr($allowed_symbols, mt_rand( 0, mb_strlen($allowed_symbols) - 1 ), 1);
            ...
            if( $no_fonts )
            {
                ...
                imagettftext($img, 17, 0, (int)($width/2-$textwidth/2), (int)(($height/2-$textheight/2)+12), $black, $font, $this->keystring);
